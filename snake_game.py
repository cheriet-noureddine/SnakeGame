...
score_msg = score_font.render("Score : ",1,pygame.Color("gray"))
...
class Apple:
    def __init__(self, x ,y,state):
        ...
        self.y = y
        self.state = state
        self.color = pygame.color.Color("#99FF33")    
...
class snake:
    ...
    def draw(self,screen):
        pygame.draw.rect(screen,pygame.color.Color("#00FFFF"), (self.stack[0].x , self.stack[0].y, 
        ...
        while(counter < len(self.stack)):
            if(self.stack[counter].color == "NULL"):
                counter +=1
                continue
            pygame.draw.rect(screen , pygame.color.Color("#3399FF"), (self.stack[counter].x,
...
def endGame():
    ...
    message_play_again = play_again_font.render("Play Again ? (Y/N) aya zid seyi",1,pygame.Color("gray"))
    screen.blit(message,(120,150))
    screen.blit(message_play_again,(80,190))
...
def drawScore(score):
    score_numb = score_numb_font.render(str(score),1,pygame.Color("white"))
    screen.blit(score_msg, (SCREEN_WIDTH - score_msg_size[0]-60,10))
    screen.blit(score_numb,(SCREEN_WIDTH - 45,14))

def drawGameTime(gameTime):
    game_time = score_font.render("Time:" , 1, pygame.Color("gray"))
